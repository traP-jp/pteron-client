...
const mockTransactions: Transaction[] = [
    {
        ...
        type: "TRANSFER",
        amount: 10000,
        project: { id: "aabbccdd-eeff-1122-3344-556677889900", name: "Project A" },
        user: { id: "11223344-5566-7788-99aa-bbccddeeff00", name: "alice" },
    ...
    },
    {
        ...
        type: "BILL_PAYMENT",
        amount: 5000,
        project: { id: "bbccddee-ff11-2233-4455-667788990011", name: "Project B" },
        user: { id: "11223344-5566-7788-99aa-bbccddeeff00", name: "alice" },
        description: "サービス利用料",
    ...
    },
    {
        ...
        type: "BILL_PAYMENT",
        amount: 3000,
        project: { id: "ccddeeff-1122-3344-5566-778899001122", name: "Project C" },
        user: { id: "11223344-5566-7788-99aa-bbccddeeff00", name: "alice" },
        description: "月額料金",
